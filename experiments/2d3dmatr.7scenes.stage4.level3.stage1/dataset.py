from vision3d.datasets.registration import RGBDScenes2D3DHardPairDataset
...
def train_valid_data_loader(cfg):
    train_dataset = RGBDScenes2D3DHardPairDataset(
    ...
    valid_dataset = RGBDScenes2D3DHardPairDataset(
        cfg.data.dataset_dir,
        "val",
...
def test_data_loader(cfg):
    ...
    test_dataset = RGBDScenes2D3DHardPairDataset(
        cfg.data.dataset_dir,
        "test",
        max_points=cfg.test.max_points,
        return_corr_indices=True,
